...
<html lang="en">
  <head>
    ...
    <title>Eco Inclusión - Login</title>
   ...
   <!-- Jalendar CSS -->
   <link rel="stylesheet" href="assets/lib/jalendar/style/jalendar.css" type="text/css" />

  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-light custom-bar">
        <div class="container">
            <a class="navbar-brand" href="index.html"><img src="assets/img/logo.svg" width="150" alt="logo"></a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#">Ingresar
                            <img src="assets/img/icon-open-account-login.svg">
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link icon-nav" href="#">Volver al sitio
                            <img src="assets/img/icon-feather-home.svg">
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Español <img src="assets/img/idioma1.svg">
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#">English <img src="assets/img/idioma2.svg"></a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group btn-group-toggle d-flex custom-btn-group" data-toggle="buttons">
                    <a href="pago-del-manual.html" class="btn btn-custom visited" role="button" aria-pressed="true">
                        <span class="icon">
                    ...
                    <a href="perfil-replicador.html" class="btn btn-custom visited" role="button" aria-pressed="true">
                        <span class="icon">
                    ...
                    <a href="descarga-manual.html" class="btn btn-custom visited" role="button" aria-pressed="true">
                        <span class="icon">
                    ...
                    <a href="sesiones-asistencia.html" class="btn btn-custom visited" role="button" aria-pressed="true">
                        <span class="icon">
